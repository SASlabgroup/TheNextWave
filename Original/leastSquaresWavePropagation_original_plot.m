function [prediction, reconstruction, params, t] = leastSquaresWavePropagation_original_plot(z_in,u_in,v_in,t_in,x_in,y_in,t_pred,x_pred,y_pred,wavespec)
...
f1 = figure();
subplot(2,2,1)
polarPcolorOrig(wavespec.f', wavespec.theta, wavespec.Etheta');
colormap('parula')
...
subplot(2,2,2)
polarPcolorOrig(wavespec.f', t(I), wavespec.Etheta');
colormap('parula')
...
subplot(2,2,3)
polarPcolorOrig(f2(1,:), thet2(:,1)'*180/pi, Ei);
colormap('parula')

subplot(2,2,4)
polarPcolorOrig(f2(1,:), thet2(:,1)'*180/pi, amps);
colormap('parula')
